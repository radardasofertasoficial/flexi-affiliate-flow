  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-50 relative flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg hover:scale-110 transition-transform"
      >
        {!isLeadRegistered() && (
